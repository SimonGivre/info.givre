...
public final class IOUtils {
	...
	/**
	 * Read everything from <code>in</code> and write to <code>out</code>
	 * until reachs the end of the input stream. Both <code>in</code> and
    ...
    /**
	 * Read everything from <code>in</code> and write to <code>out</code>
	 * until reachs the end of the input stream. If <code>closeOnFinish</code>
	 * is <code>true</code>, it quitely closes both <code>in</code> and
    ...
    public static void copyStream(InputStream in, OutputStream out, boolean closeOnFinish) throws IOException {
        ...
        try {
            ...
            if (closeOnFinish) close(in);
            if (closeOnFinish) close(out);
        }
    }
    
    /**
     * Quietly close a {@linkplain java.io.InputStream}. 
    ...
    /**
     * Quietly close a {@linkplain java.io.InputStream} without
     * throwing any exception. Exceptions will be logged as error 
     * if the <code>logError</code> is <code>true</code>.
     * 
     * @param in  the input stream to close
    ...
    /**
     * Quietly close a {@linkplain java.io.OutputStream}.
     * Exceptions are discarded.
     * 
    ...
    /**
     * Quietly close a {@linkplain java.io.OutputStream} without
     * throwing any exception. Exceptions will be logged as error 
     * if the <code>logError</code> is <code>true</code>.
     * 
     * @param out  the output stream to close
